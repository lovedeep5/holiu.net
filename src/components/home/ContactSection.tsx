      ...
      <div className="container-max relative z-10">
        ...
        {status === "sent" ? (
          ...
          <form
            ...
            style={{ maxWidth: "600px", margin: "0 auto", display: "flex", flexDirection: "column", gap: "1.25rem" }}
          >
            <div>
              <label htmlFor="cname" style={labelStyle}>Your name</label>
              <input
                id="cname"
                type="text"
                required
            ...
            <div>
              <label htmlFor="cemail" style={labelStyle}>Your email</label>
              <input
                id="cemail"
                type="email"
                required
            ...
            <div>
              <label htmlFor="cmessage" style={labelStyle}>Message</label>
              <textarea
                id="cmessage"
                required
                rows={5}
